...
const SCENARIOS = [
  {
    ...
    object:'Opportunity', templateId:'a0H01',
    dateField:'Renewal_Date__c', window:'THIS_MONTH', allowOverride:true,
    extraFilter:'', resolverClass:'', sortField:'Renewal_Date__c', maxRecords:50,
    documentAction:'',
  ...
  },
  {
    ...
    object:'Account', templateId:'a0H03',
    dateField:'Pilot_Accepted_Date__c', window:'THIS_WEEK', allowOverride:true,
    extraFilter:"Pilot_Status__c = 'Accepted'", resolverClass:'', sortField:'', maxRecords:25,
    documentAction:'act2',
  ...
  },
  {
    ...
    object:'Case', templateId:'a0H06',
    dateField:'ClosedDate', window:'THIS_WEEK', allowOverride:true,
    extraFilter:"Status = 'Closed'", resolverClass:'', sortField:'', maxRecords:50,
    documentAction:'',
  ...
  },
  {
    ...
    object:'Account', templateId:'a0H04',
    dateField:'', window:'', allowOverride:false,
    extraFilter:"Type = 'Customer' AND Active__c = true", resolverClass:'', sortField:'Name', maxRecords:100,
    documentAction:'',
  ...
  },
  {
    ...
    object:'Account', templateId:'a0H05',
    dateField:'', window:'', allowOverride:false,
    extraFilter:'', resolverClass:'UnsignedNdaResolver', sortField:'Name', maxRecords:50,
    documentAction:'act2',
